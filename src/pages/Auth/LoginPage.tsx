      ...
      .then(() => {
        ...
        renderGoogleLoginButton(buttonContainer, async (credential) => {
          ...
          try {
            ...
            localStorage.setItem("accessTokenExpiresAt", loginResponse.expiresAt);
      ...
      <main className="flex flex-1 flex-col px-[33px]">
        ...
        <div className="mt-auto pb-[49px]">
          <div
            ...
            className={[
              "flex h-[55px] w-full justify-center",
              isLoggingIn ? "pointer-events-none opacity-60" : "",
            ].join(" ")}
          />

          {errorMessage && (
            <p className="mt-[11px] text-center text-caption text-danger">
              {errorMessage}
            </p>
          )}
