...
export function BottomSheet({
  ...
  return (
    <div
      ref={sheetRootRef}
      className="fixed left-1/2 top-[var(--app-top,0px)] z-[100] h-[var(--app-height,100dvh)] w-full max-w-[390px] -translate-x-1/2 overflow-hidden overscroll-none bg-surface-placeholder"
    >
      <button
        type="button"
